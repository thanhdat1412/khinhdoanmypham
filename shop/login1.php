        ...
        <div class="login w3_login">
            ...
            <div class="w3l_grid">
               	<form class="login-container" action="" method="post"> 
                    <input type="number" placeholder="Số điện thoại" Name="txtuser" >
			...
			?>
                <div class="second-section w3_section">
                    ...
                    <div class="social-links w3_social">
                        <ul>
                            <!-- facebook -->
                            <li> <a class="facebook" href="<?php $loginUrl?>" target=""><i class="icon-facebook"></i></a></li>
                            <!-- google plus -->
