...
//				{ 
//					if($_SESSION["cart"][$key]['idsanpham'] == $_POST['idsanpham'])
//					{
//						
//					$avaiable++;
//					}					
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						...
						<div class="col-md-12">
                    <h3 style="font-family: 'Palatino Linotype', 'Book Antiqua', Palatino, serif;margin-top:10px;">GIỎ HÀNG</h3>
                    <table width="1000" border="1" cellpadding="2" cellspacing="0" style="font-weight:bold">
						
                      <tr class='column' style="background-color:#c8c8c8 ">
                        <td width="7%">THỨ TỰ</td>
                        <td width="20%">SẢN PHẨM</td>
                        <td width="20%">TÊN THÚ CƯNG</td>
                        <td width="16%">GIÁ</td>
                      ...
                      <tr style="background-color:#D3FDE7">
                        <td><?php echo $dem++ ?></td>
                        <td><img src='images/<?php echo $value['Anh'] ?>' width="60%" /></td>
					    <td><?php echo $value['TenSP']  ?></td>
                        <td><?php echo $value['Gia'] ?></td>
		                <td><?php echo $value['Gia'] ?></td>
						<td>
						    <input type='hidden' name="delete_id" value="<?php echo $value['idsanpham'] ?>"/>
							 <input type='submit' class="btn btn bg-warning" name="delete_id" value="Xóa sản phẩm"/>
						</td>
                      </tr>
								<?php
								}
                      ...
                      <tr  style="background-color:#c8c8c8 ">
                        ...
                        <td colspan=''><span style="color:#D90509" ><?php echo number_format($total).'.000₫' ?></span></td>
						  <td>  <p style="font-family: 'Palatino Linotype', 'Book Antiqua', Palatino, serif;margin-top:10px;">
