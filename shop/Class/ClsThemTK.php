...
{
echo '<script language="javascript">alert("Số điện thoại đã được sử dụng!"); window.location="../Admin/taikhoankh.php";</script>';
...
echo '<script language="javascript">alert("Có lỗi trong quá trình xử lý"); window.location="../Admin/taikhoankh.php";</script>';
}
}
}
?>