    ...
    <div class="card-body">
      ...
      <form action="#" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="txtuser" placeholder="SDT">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block" name="dangnhap" value="Đăng nhập">Sign In</button>
          </div>
			<div class="col-12" align="center" style="font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif';color: red;">
			<?php
